import { Navbar, NavbarBrand, NavbarContent, NavbarItem, Link, DropdownItem, DropdownTrigger, Dropdown, DropdownMenu, Avatar, Input, Modal, ModalContent, ModalBody, ModalFooter, Button, useDisclosure } from "@nextui-org/react";
  ...
  return (
    <>
      <Navbar maxWidth="xl" position="sticky" className="flex ">
        ...
        <NavbarContent className="hidden sm:flex gap-4  ml-4" justify="center">
          <Dropdown>
            <NavbarItem>
              <DropdownTrigger>
                <Button
